...
class salesmanRequestById extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'salesmanRequestById',
  ...
  factory salesmanRequestById.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory salesmanRequestById.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      ...
      'Will be removed in next major version')
  salesmanRequestById copyWith(void Function(salesmanRequestById) updates) =>
      super.copyWith((message) => updates(message as salesmanRequestById))
          as salesmanRequestById; // ignore: deprecated_member_use
  ...
  @$core.pragma('dart2js:noInline')
  static salesmanRequestById getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<salesmanRequestById>(create);
...
class SalesmanMsg extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'SalesmanMsg',
      createEmptyInstance: create)
    ..a<$core.int>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Id', $pb.PbFieldType.OU3,
        protoName: 'Id')
    ..a<$core.int>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'PhoneNumer', $pb.PbFieldType.OU3,
        protoName: 'PhoneNumer')
  ...
  factory SalesmanMsg.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory SalesmanMsg.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  SalesmanMsg copyWith(void Function(SalesmanMsg) updates) =>
      super.copyWith((message) => updates(message as SalesmanMsg)) as SalesmanMsg; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class RequestReplyWithSalesman extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RequestReplyWithSalesman',
      createEmptyInstance: create)
    ..aOM<$1.RequestResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Result',
        protoName: 'Result', subBuilder: $1.RequestResult.create)
    ..aOM<SalesmanMsg>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Salesman',
        protoName: 'Salesman', subBuilder: SalesmanMsg.create)
    ..hasRequiredFields = false;
  ...
  factory RequestReplyWithSalesman.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RequestReplyWithSalesman.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RequestReplyWithSalesman copyWith(void Function(RequestReplyWithSalesman) updates) =>
      super.copyWith((message) => updates(message as RequestReplyWithSalesman))
          as RequestReplyWithSalesman; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static RequestReplyWithSalesman getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RequestReplyWithSalesman>(create);
  static RequestReplyWithSalesman? _defaultInstance;

  @$pb.TagNumber(1)
  $1.RequestResult get result => $_getN(0);
  @$pb.TagNumber(1)
  set result($1.RequestResult v) {
    setField(1, v);
  }
...
class RequestReplySalesmen extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'RequestReplySalesmen',
      createEmptyInstance: create)
    ..aOM<$1.RequestResult>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Result',
        protoName: 'Result', subBuilder: $1.RequestResult.create)
    ..pc<SalesmanMsg>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'Salesmen', $pb.PbFieldType.PM,
        protoName: 'Salesmen', subBuilder: SalesmanMsg.create)
    ..hasRequiredFields = false;
  ...
  factory RequestReplySalesmen.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory RequestReplySalesmen.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  ...
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  RequestReplySalesmen copyWith(void Function(RequestReplySalesmen) updates) =>
      super.copyWith((message) => updates(message as RequestReplySalesmen))
          as RequestReplySalesmen; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  ...
  @$core.pragma('dart2js:noInline')
  static RequestReplySalesmen getDefault() =>
      _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<RequestReplySalesmen>(create);
