...
void main() {
  ...
  env.SetFromFile("assets/appsettings.development.json").whenComplete(() => _runApp());
}
...
void _runApp() {
  runApp(MultiRepositoryProvider(
    ...
    child: MaterialApp(
        ...
        home: BlocProvider(
          create: (BuildContext context) => SalesmanCubit(RepositoryProvider.of<SalesmanRepository>(context)),
